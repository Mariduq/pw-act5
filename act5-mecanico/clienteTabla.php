<?php
    ...
    $query = "SELECT * FROM mecanico_clientes WHERE estado='SI'";
                ...
                <tbody>
                    <?php while($fila = mysqli_fetch_array($rs)){  ?>
                        <tr>
                            ...
                            <td>
                                <a onclick='abreModCliente("<?php echo $ced?>", "<?php echo $name?>", "<?php echo $direccion?>");'><i class="material-icons">edit</i></a>
