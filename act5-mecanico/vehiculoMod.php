<div class="fondo-color">
    ...
    <div class="form-format2 rounded shadow-sm bg-white">
        <h3><b>Modificar Vehículo</b></h3><br>
        
        <form id="uploadModForm" action="assets/php/vehiculoMod.php" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col">
           ...
           <div class="row">
                <div class="col">
                    <input value="<?php echo $_POST['ano']; ?>" name="ano" id="ano" class="form-control" type="text" placeholder="Año" aria-label="default input example" required><br>
                </div>
                <div class="col">
