    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
            ...
            if ($uploadOk == 0) {
                ...
                if(is_numeric($cantidad) && is_numeric($costo)){
                    ...
                    if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
                        ...
                        $query = "UPDATE mecanico_repuestos SET codigo='$codigo',nombre='$nombre', marca='$marca', modelo='$modelo', tipo='$tipo', clasificacion='$clasificacion', cantidad='$cantidad', descripcion='$descripcion', imagenruta='$targetFile', costo='$costo' WHERE idmecanico_repuestos='$id'";
            ...
            if(is_numeric($cantidad) && is_numeric($costo)){
                ...
                $query = "UPDATE mecanico_repuestos SET codigo='$codigo',nombre='$nombre', marca='$marca', modelo='$modelo', tipo='$tipo', clasificacion='$clasificacion', cantidad='$cantidad', descripcion='$descripcion', costo='$costo' WHERE idmecanico_repuestos='$id'";
                ...
                echo "<script>alert('Los campos cantidad y costo solo pueden tener números');</script>";
            }
        }
