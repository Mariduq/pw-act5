<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
            ...
            $sqlid = "SELECT MAX(idmecanico_vehiculos) AS lastid FROM mecanico_vehiculos WHERE 1;";
            ...
            $targetFile = $targetDir . "vehiculo". $indice. ".". pathinfo($oldImageName, PATHINFO_EXTENSION);
            ...
            if ($uploadOk == 0) {
                ...
                if(is_numeric($ano) && is_numeric($cantidad) && is_numeric($costo)){
                    ...
                    if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
                        ...
                        $query = "INSERT INTO mecanico_vehiculos(marca, modelo, descripcion, tipo, ano, cantidad, imagenruta, costo, estado) VALUES('$marca', '$modelo', '$descripcion', '$tipo', '$ano', '$cantidad', '$imageRoute', '$costo', 'SI')";
